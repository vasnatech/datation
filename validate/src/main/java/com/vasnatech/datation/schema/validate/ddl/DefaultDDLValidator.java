...
public class DefaultDDLValidator implements DDLValidator {

    @Override
    public List<ValidationInfo> validate(Schemas schemas) {
    ...
    private void validateSchema(Schema schema, ValidationInfo.Builder validationInfoBuilder) {
    ...
    private void validateTable(Schema schema, Table table, ValidationInfo.Builder validationInfoBuilder) {
        ...
        for (Column column : table.getColumns().values()) {
            validateColumn(schema, table, column, validationInfoBuilder);
        }

        for (Index index : table.getIndexes().values()) {
            validateIndex(schema, table, index, validationInfoBuilder);
        }
    ...
    private void validateColumn(Schema schema, Table table, Column column, ValidationInfo.Builder validationInfoBuilder) {
    ...
    private void validateIndex(Schema schema, Table table, Index index, ValidationInfo.Builder validationInfoBuilder) {
    ...
    private void validateForeignKey(Schema schema, Table table, ForeignKey foreignKey, ValidationInfo.Builder validationInfoBuilder) {
